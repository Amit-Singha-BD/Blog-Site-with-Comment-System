                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.posts.update', $post->id )}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="post_title" class="form-control form-control-lg" value="{{ $post->post_title }}" id="postTitle" placeholder="Enter post title">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="postCategory" name="categories">
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" {{ $category->id == $post->category_id ? 'selected' : ''}}>{{ $category->categories_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="slug" class="form-control" value="{{ $post->slug }}" id="postSlug" placeholder="Add Slug Url">
                            </div>

                            <div class="mb-4">
                                <label for="postContent" class="form-label">Post Content</label>
                                <textarea name="description" class="form-control" id="postContent" rows="10" placeholder="Write your post content here...">{{ $post->description }}</textarea>
                            </div>
                                ...
                                <div class="collapse" id="seoCollapse">
                                    <div class="card card-body mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="meta_title" class="form-control" value="{{ $post->mete_title }}" id="metaTitle" placeholder="Meta title for SEO">
                                            <div class="form-text">Optimize for search engines (up to 60 characters)</div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="metaDescription" class="form-label">Meta Description</label>
                                            <textarea type="text" class="form-control" name="meta_description" id="metaDescription" rows="3" placeholder="Meta description for SEO">{{ $post->meta_description }}</textarea>
